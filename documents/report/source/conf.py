# -*- coding: utf-8 -*-
#
# Database project documentation build configuration file, created by
...
project = u'Database project'
copyright = u'2012, Amos Wenger, Sebastien Zurfluh & Yoan Blanc'
...
htmlhelp_basename = 'Databaseprojectdoc'
...
man_pages = [
    ('index', 'databaseproject', u'Database project Documentation',
     [u'Amos Wenger, Sebastien Zurfluh & Yoan Blanc'], 1)
]
